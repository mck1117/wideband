...
#define LSUADV_HEATER_CLOSED_LOOP_THRESHOLD_ESR 500
#define LSUADV_HEATER_TARGET_ESR 300
#define LSUADV_HEATER_OVERHEAT_ESR 150
#define LSUADV_HEATER_UNDERHEAT_ESR 700
